...
const Home = () => {
  ...
  useEffect(() => {
    const filteredtrendingProducts = products.filter(
      (itme) => itme.category === "bota"
    );
    const filteredBestSalesProducts = products.filter(
      (itme) => itme.category === "zapato"
    );

    const filteredMobileProducts = products.filter(
      (itme) => itme.category === "zapatilla"
    );
    const filteredWirelessProducts = products.filter(
      (itme) => itme.category === "sandalia"
    );
    const filteredPopularProducts = products.filter(
      (itme) => itme.category === "cartera"
    );
    const filteredUnicProducts = products.filter(
      (itme) => itme.category === "borcego"
    );
            ...
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <p>
                  ...
                  Necessitatibus doloremque beatae excepturi quibusdam. Suscipit
                  doloribus impedit odit, ipsa totam harum.
                </p>
